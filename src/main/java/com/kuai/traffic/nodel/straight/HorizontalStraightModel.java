...
public class HorizontalStraightModel extends TrafficModel {
	private Logger log = Logger.getLogger(HorizontalStraightModel.class);
	
	public HorizontalStraightModel() {
		super();
	}
...
//	}
  ...
  public void render(TrafficRender render) {
    ...
    log.info("render::baseSegment: " + position + ", " + baseSegment.toString());
